...
namespace Common.Media.NAudio
{
    public class VarispeedWaveProvider : IWaveProvider
    {
        ...
        public VarispeedWaveProvider(IWaveProvider source)
        {
