...
{
    internal class SoundCloudBlockWaveRendererSettings : WaveRendererSettings
    {
        ...
        public SoundCloudBlockWaveRendererSettings(Color topPeakColor, Color topSpacerStartColor, Color bottomPeakColor, Color bottomSpacerColor)
        {
